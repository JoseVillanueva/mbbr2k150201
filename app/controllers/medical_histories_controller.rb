class MedicalHistoriesController < ApplicationController
  ...
  private
    ...
    def medical_history_params
      params.require(:medical_history).permit(:date_register, :description, :weight_picture, :height_picture, :type_picture, :picture, :Medical_insurance_id, :Medical_center_id, :Medicine_id, :Medical_exam_id, :Doctor_id, :Child_id, :Health_problem_id)
    end
end
